...
const DEFAULT_DIRECT_MESSAGE_PREFIX = "[direct]"
...
export function normalizeReplyListenerConfig(config: OpenClawConfig): OpenClawConfig {
  ...
  const normalizedReplyListener: OpenClawReplyListenerConfig = {
    ...
    authorizedDiscordUserIds: Array.isArray(replyListener.authorizedDiscordUserIds)
      ...
      : [],
    // New direct message fields
    acceptDirectMessages: replyListener.acceptDirectMessages === true,
    directMessageTargetPane: typeof replyListener.directMessageTargetPane === "string"
      ? replyListener.directMessageTargetPane
      : undefined,
    directMessagePrefix: typeof replyListener.directMessagePrefix === "string"
      ? replyListener.directMessagePrefix
      : DEFAULT_DIRECT_MESSAGE_PREFIX,
  }
