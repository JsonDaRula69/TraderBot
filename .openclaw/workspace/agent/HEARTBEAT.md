...
- name: news-scan
  interval: 2h
  prompt: "Run `traderbot news-summary --signals --json` to check for high-impact news signals. If any impact score > 0.7, surface alert to sysadmin. Also run `traderbot news-context <your_active_category> --json` for pre-trade sentiment context."
